...
<meta name="viewport" content="width=device-width, initial-scale=1">-->
  <title>Все товары |агродроны, запасные части , метеосистемы, аксессуары </title>
</head>
        ...
        <div class="container">
          <div class="section_texts">
            ...
            <div class="description">
              Профессианальное оборудование для цифрового цемледелия
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="delivery__cards">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Агродроны</h3>
                <p class="delivery__card-desrc">
                  Революция в опрыскивании. Точность, экономия ресурсов и защита урожая. С современными агродронами вы эффективно внесете СЗР, минимизируя затраты и повышая урожайность. Технологичное решение для успешного сельского хозяйства и здорового будущего ваших посевов!"
                </p>
                <div class="delivery__pricelst">
                  <span class="delivery__pricelst-price">20 000</span>
                  <span class="delivery__pricelst-val">₽</span>
                </div>
                <div class="container-img">
                  <div class="delivery__card-img">
                    <img src="..\img\tagros501.png" alt="Робот" />
                  </div>
                </div>
              </a>
            </div>
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Запчасти для агродронов</h3>
                <p class="delivery__card-desrc">
                  Надежные запчасти для агродронов — ваш ключ к стабильной работе на поле! Обеспеч бесперебойную дронов с нашими высококачественными запчастями. Мы предлагаем все необходимое для поддержания ваших дронов в идеальном состоянии, чтобы каждый сезон был успешным и продуктивным.
                </p>
                <div class="delivery__pricelst">
                  <span class="delivery__pricelst-price">20 000</span>
                  <span class="delivery__pricelst-val">₽</span>
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Аксессуары для агродронов</h3>
                <p class="delivery__card-desrc">
                   Аксессуары помогут оптимизировать каждый этап опрыскивания, сделав его более удобным и безопасным. Полный комплект для максимальной производительности!"
                </p>
                <div class="delivery__pricelst">
                  <span class="delivery__pricelst-price">20 000</span>
                  <span class="delivery__pricelst-val">₽</span>
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Метеосистемы CERES</h3>
                <p class="delivery__card-desrc">
                  Распределенная сеть агродатчиков, предназначенная для сбора более 20 различных параметров с полей, виноградников, садов и теплиц.
                </p>
                <div class="delivery__pricelst">
                     <span class="delivery__pricelst-val">от</span>
                  <span class="delivery__pricelst-price">20 000</span>
                  <span class="delivery__pricelst-val">₽</span>
                </div>
                <div class="container-img">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Квадрокоптеры</h3>
                <p class="delivery__card-desrc">
                  Отличный помошник для мониторинга и исследовани ваших полей
                </p>
                <div class="delivery__pricelst">
                  <span class="delivery__pricelst-price">20 000</span>
                  <span class="delivery__pricelst-val">₽</span>
