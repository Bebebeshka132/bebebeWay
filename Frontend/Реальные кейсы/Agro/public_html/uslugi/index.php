          ...
          <div class="delivery__cards">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Обработка полей агродронами</h3>
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Десикация агродронами</h3>
                <p class="delivery__card-desrc">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Внесение СЗР агродронами</h3>
                <p class="delivery__card-desrc">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Crop мониторинг полей</h3>
                <p class="delivery__card-desrc">
            ...
            <div class="delivery__card">
              <a href="https://e.mail.ru/inbox/" class="card__link">
                <h3 class="delivery__card-title">Опредление индекса NDVI</h3>
                <p class="delivery__card-desrc">
